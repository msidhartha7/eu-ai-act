---
title: "Article 56: Codes of Practice"
source_url: "https://artificialintelligenceact.eu/article/56/"
slug: "article-56"
content_type: "article"
language: "en"
source: "sitemap"
scraped_at: "2026-04-16T15:43:56+00:00"
published_at: null
updated_at: null
description: null
word_count: 677
...
2. The AI Office and the Board shall aim to ensure that the codes of practice cover at least the obligations provided for in[Articles 53](https://artificialintelligenceact.eu/article/53/)and[55](https://artificialintelligenceact.eu/article/55/), including the following issues:

(a) the means to ensure that the information referred to in[Article 53](https://artificialintelligenceact.eu/article/53)(1), points (a) and (b), is kept up to date in light of market and technological developments;
...
6. The AI Office and the Board shall regularly monitor and evaluate the achievement of the objectives of the codes of practice by the participants and their contribution to the proper application of this Regulation. The AI Office and the Board shall assess whether the codes of practice cover the obligations provided for in[Articles 53](https://artificialintelligenceact.eu/article/53/)and[55](https://artificialintelligenceact.eu/article/55/), and shall regularly monitor and evaluate the achievement of their objectives. They shall publish their assessment of the adequacy of the codes of practice.

The Commission may, by way of an implementing act, approve a code of practice and give it a general validity within the Union. That implementing act shall be adopted in accordance with the examination procedure referred to in[Article 98](https://artificialintelligenceact.eu/article/98)(2).

7. The AI Office may invite all providers of general-purpose AI models to adhere to the codes of practice. For providers of general-purpose AI models not presenting systemic risks this adherence may be limited to the obligations provided for in[Article 53](https://artificialintelligenceact.eu/article/53), unless they declare explicitly their interest to join the full code.
...
9. Codes of practice shall be ready at the latest by 2 May 2025. The AI Office shall take the necessary steps, including inviting providers pursuant to paragraph 7. If, by 2 August 2025, a code of practice cannot be finalised, or if the AI Office deems it is not adequate following its assessment under paragraph 6 of this Article, the Commission may provide, by means of implementing acts, common rules for the implementation of the obligations provided for in[Articles 53](https://artificialintelligenceact.eu/article/53/)and[55](https://artificialintelligenceact.eu/article/55/), including the issues set out in paragraph 2 of this Article. Those implementing acts shall be adopted in accordance with the examination procedure referred to in[Article 98](https://artificialintelligenceact.eu/article/98)(2).
