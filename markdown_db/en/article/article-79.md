---
title: "Article 79: Procedure at National Level for Dealing with AI Systems Presenting a Risk"
source_url: "https://artificialintelligenceact.eu/article/79/"
slug: "article-79"
content_type: "article"
language: "en"
source: "sitemap"
scraped_at: "2026-04-16T15:45:10+00:00"
published_at: null
updated_at: null
description: null
word_count: 824
...
(a) non-compliance with the prohibition of the AI practices referred to in[Article 5](https://artificialintelligenceact.eu/article/5);

(b) a failure of a high-risk AI system to meet requirements set out in[Chapter III](https://artificialintelligenceact.eu/chapter/3), Section 2;

(c) shortcomings in the harmonised standards or common specifications referred to in[Articles 40](https://artificialintelligenceact.eu/article/40/)and[41](https://artificialintelligenceact.eu/article/41/)conferring a presumption of conformity;

(d) non-compliance with[Article 50](https://artificialintelligenceact.eu/article/50).
...
8. Where, within three months of receipt of the notification referred to in paragraph 5 of this Article, no objection has been raised by either a market surveillance authority of a Member State or by the Commission in respect of a provisional measure taken by a market surveillance authority of another Member State, that measure shall be deemed justified. This shall be without prejudice to the procedural rights of the concerned operator in accordance with Article 18 of Regulation (EU) 2019/1020. The three-month period referred to in this paragraph shall be reduced to 30 days in the event of non-compliance with the prohibition of the AI practices referred to in[Article 5](https://artificialintelligenceact.eu/article/5)of this Regulation.
